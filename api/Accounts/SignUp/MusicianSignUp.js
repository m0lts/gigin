    ...
    try {
        ...
        if (request.method === "POST") {
            ...
            if (emailInMusicianDatabase) {
                ...
                return;
            } else if (emailInPromoterDatabase) {
                response.status(401).json({ error: 'That email address is associated with a promoter account.' });
                return;
            ...
            const result = await musicianCollection.insertOne(dataReceived);
